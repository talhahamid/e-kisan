...
/*if($productsprice): 
    //$pid = $productsprice['id'];
    print_r($productsprice);
endif;
exit;*/
?>
<?php if($sales_category): ?>
<?php foreach($sales_category as $category): ?>
        ...
        <div class="card text-white bg-flat-color-5">   
            <div class="card-body pb-0">
                ...
                <h4 class="mb-0">
                    ...
                    <a href="<?php echo base_url('Farmers/'.$sname.'price/'.$category['id'])?>">  
                           <h3 class="text-light">
