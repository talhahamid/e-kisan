                        ...
                        <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="bootstrap-data-table_info">
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting" aria-controls="bootstrap-data-table" style="width: 225px;">Quantity</th>
                                    <th class="sorting" aria-controls="bootstrap-data-table" style="width: 148px;">Rate</th>
                                    <th class="sorting" aria-controls="bootstrap-data-table" style="width: 175px;">Total Price</th>
                                    ...
                                    <th class="sorting" aria-controls="bootstrap-data-table" style="width: 400px; padding-left: 100px;">Action</th>
                                ...
                                <tbody> 
                                    ...
                                    <tr role="row" class="odd">
                                        <td><?php echo $productsprice['name']; ?></td>
                                        <td><?php echo $productsprice['quantity']; ?></td>
                                        <td><?php echo $productsprice['rate']; ?></td>
                                        <td>
                                            <?php echo ($productsprice['quantity'] * $productsprice['rate']); ?>
                                        </td>
                                        <td><?php echo $productsprice['address']; ?></td>
                                        <td><?php echo $productsprice['type']; ?></td>
                                        <td><?php echo $productsprice['quality']; ?></td>
                                        <td>
                                            <a href="<?php echo base_url('Farmers/Productspriceedit/'.$productsprice['id'])?>">
                                                <input type="submit" style="width: 100px;" name="edit" value="EDIT" class="btn btn-primary form-control">
                                            </a>
                                            <a href="<?php echo base_url('Farmers/Productspricedelete/'.$productsprice['id'])?>">
