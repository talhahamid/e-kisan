...
<?php if($resources_seedscategory): ?>
<?php foreach($resources_seedscategory as $resources_seedscategory): ?>
    <div class="col-sm-6 col-lg-3">
        <div class="card text-white bg-flat-color-2">
            <div class="card-body pb-0">
                ...
                <a href="<?php echo base_url('Farmers/oxdetails')?>">
                <h3 class="text-light"><?php echo $resources_seedscategory['name']; ?></h3>
                </a>
