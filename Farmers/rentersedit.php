        ...
        <div class="container">
            <div class="login-content"> 
                <div class="login-form">
                    <h3>Edit Renters</h3><hr><br>
                    <form method="post" id="rentersedit" action="<?php echo base_url('Farmers/rentersupdate')?>">
                        <input type="hidden" name="id" value="<?php echo $renters['id']; ?>">
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" name="name" value="<?php echo $renters['name']; ?>" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" name="rent" value="<?php echo $renters['rent']; ?>" class="form-control">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" name="duration" value="<?php echo $renters['duration']; ?>" class="form-control">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" name="contacts" value="<?php echo $renters['contact']; ?>" class="form-control">
                            </div>
                        </div>
                        <br><hr>
