    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="\E-Kisan\E-KISAN\home.php">E-KISAN</a>
            </div>-->
    
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li><a href="farmerslist.php">Farmers</a></li>
                    <li><a href="dealerslist.php">Dealers</a></li>
                    <li><a href="\E-Kisan\index.php">Logout</a></li>
                </ul>
            </div>
        </nav>
    </aside>
