    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="#">E-KISAN</a>
            </div>-->
    
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="<?php echo base_url('Dealers/dealerprofile')?>">Profile
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('Dealers/farmerslist')?>">     Farmers
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('Dealers/buy')?>">
                             Buy
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('Dealers/deliverymenlist')?>">Delivery Men
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('Dealers/transactions')?>">    Transactions
                        </a>
                    </li>
                    <li>
